...
class HistoryController extends Controller
{
    ...
    {
        return Excel::download(new SurveyExport($id), 'export.xlsx');
    }
    public function exporte($id)
    {
        $user = User::findOrFail($id);
        ...
        // $jawabans = Jawaban::where('historyId', $history->id)->get();
        return view('admin.tables.survey', compact('user', 'history', 'progresses', 'historyList'));
    }
