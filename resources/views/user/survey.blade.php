...
{{-- MODAL --}}
<div class="modal fade" id="surveyModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div>
                    ...
                    <div class="rounded bg-light2 px-3 py-3 my-2">
                        <div class=" d-flex justify-content-lg-between align-items-center">
                            ...
                            <a class="d-flex text-decoration-none text-gray-700 align-items-center " id="muter-" data-toggle="collapse" href="#detailRiwayat-1" role="button">
                                <p class=" m-0">Senin, 30-08-2021</p>
                                <i class="fa fa-chevron-down mx-2" aria-hidden="true"></i>
                            </a>
                        </div>
                        <div id="detailRiwayat-1" class="collapse container ml-5">
                            <ul class="list-unstyled m-0">
                                <li>Dimensi 1 : 90</li>
                                <li>Dimensi 1 : 90</li>
                                <li>Dimensi 1 : 90</li>    
